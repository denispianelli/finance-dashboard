...
export async function extractStatement(
  ...
  // Categorization is no longer computed at extract: the Review shows only the
  // transactions/figures (ADR-013 amendment). The deterministic cascade runs at
  // insert, and the LLM tier runs in the background after import.
