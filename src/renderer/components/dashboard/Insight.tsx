...
export function Insight({ children }: { children: ReactNode }) {
  return (
    <div className="relative flex flex-col gap-3 py-[18px] pl-8 pr-5 before:absolute before:bottom-[18px] before:left-3.5 before:top-[18px] before:w-px before:bg-brass before:content-['']">
